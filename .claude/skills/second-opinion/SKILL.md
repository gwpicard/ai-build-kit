...
---
<!-- GENERATED from .agents/skills/second-opinion/. Do not edit here; regenerate with .agents/tools/build-adapters.sh -->

When this skill comes from a Claude plugin, load and follow `${CLAUDE_PLUGIN_ROOT}/.agents/skills/second-opinion/SKILL.md`. Otherwise, load and follow `.agents/skills/second-opinion/SKILL.md`. It is the single source of truth for this skill.
