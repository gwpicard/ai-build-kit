...
---
<!-- GENERATED from .agents/skills/grilling/. Do not edit here; regenerate with .agents/tools/build-adapters.sh -->

Load and follow `.agents/skills/grilling/SKILL.md`, the single source of truth for this skill.
