...
| [Anthropic's frontend-design skill](https://github.com/anthropics/skills/tree/34040c9c568585f6929bedeaad110ad08f079624/skills/frontend-design) | The Apache-2.0 design-taste skill vendored into projects with a screen, so their visual direction starts from the subject rather than a generic generated style |
| [shadcn/ui CLI](https://ui.shadcn.com/docs/cli) | The one-command route that adds a registry theme to a React project and sets up shadcn/ui when the project has no component configuration yet |
| [tweakcn](https://tweakcn.com/) | The theme registry used to give a React screen project a chosen set of local CSS variables |
| [daisyUI installation guide](https://daisyui.com/docs/install/) | The current package command used for a screen stack that is not React |
