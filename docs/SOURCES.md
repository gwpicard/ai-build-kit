...
| [github/spec-kit](https://github.com/github/spec-kit) | The read-only pass that compares what was promised against what is planned, reports what has nothing behind it in one list, and changes nothing by itself |
