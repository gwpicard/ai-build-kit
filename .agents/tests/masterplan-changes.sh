...
rs_require_load_bearing "monthly maintenance reads the count rules" "$MAINTAIN" 'count landed changes since it using `.agents/skills/setup-ai-build-kit/references/masterplan-changes\.md`'
